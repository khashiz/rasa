...
.red {
	...
	<div class="rsform-column-10">
		...
		<?php } ?>
		<h2>Changelog v3.0.18</h2>
		<ul class="version-history">
			<li><span class="version-fixed">Fix</span> Birthday Field would incorrectly save submissions as "00 / 00 /" if no values were provided.</li>
			<li><span class="version-fixed">Fix</span> In some cases restoring a backup taken from Joomla! 4 would fail.</li>
		</ul>
