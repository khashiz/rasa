...
<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<div class="page-header uk-margin-bottom">
		<<?php echo $htag; ?> itemprop="headline" class="font f700 uk-h4 uk-text-secondary uk-margin-remove">
	...
	<div itemprop="articleBody" class="font f500 uk-text-secondary com-content-article__body">
...
<div class="uk-grid-column-small uk-grid-row-medium uk-grid-match" data-uk-grid>
    ...
    <div class="uk-width-1-1 uk-width-auto@s uk-flex uk-flex-middle uk-flex-center readmore">
        <a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($this->item->slug)); ?>" class="uk-display-inline-block uk-text-center font"><?php echo JText::sprintf('BACKTO').' '.$this->item->category_title; ?><i class="far fa-chevron-double-<?php echo JFactory::getLanguage()->isRtl() ? 'left':'right'; ?>"></i></a>
    </div>
</div>