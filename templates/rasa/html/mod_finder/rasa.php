...
$input = '<input type="search" name="q" id="mod-finder-searchword' . $module->id . '" class="uk-width-1-1 js-finder-search-query form-control" value="' . htmlspecialchars($app->input->get('q', '', 'string'), ENT_COMPAT, 'UTF-8') . '"'
