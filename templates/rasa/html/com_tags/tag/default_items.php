...
<div class="com-tags__items">
	...
	<?php else : ?>
		<ul class="uk-list uk-list-divider uk-list-collapse com-tags-tag__category category list-group uk-text-zero">
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<?php else : ?>
					<h3 class="uk-text-small">
						<a class="uk-display-block font uk-text-secondary f700 uk-padding-small uk-padding-remove-horizontal" href="<?php echo Route::_($item->link); ?>">
							<?php echo $this->escape($item->core_title); ?>
						</a>
					</h3>
				<?php endif; ?>
