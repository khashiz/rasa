...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo JUri::base().'templates/tavanresan/img/favicons/apple-touch-icon.png'; ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo JUri::base().'templates/tavanresan/img/favicons/favicon-32x32.png'; ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo JUri::base().'templates/tavanresan/img/favicons/favicon-16x16.png'; ?>">
    <link rel="manifest" href="<?php echo JUri::base().'templates/tavanresan/img/favicons/site.webmanifest'; ?>">
</head>
<body class="<?php echo $option . ' view-' . $view . ($layout ? ' layout-' . $layout : ' no-layout') . ($task ? ' task-' . $task : ' no-task') . ($itemid ? ' itemid-' . $itemid : '') . ($pageclass ? ' ' . $pageclass : '') . ($this->direction == 'rtl' ? ' rtl' : ''); ?>">
    ...
    <?php if ($pageparams->get('show_page_heading', 0)) { ?>
        <section class="uk-background-accent uk-padding-large uk-padding-remove-horizontal pageHead">
            <div>
                <div class="uk-container">
    ...
    <div class="uk-width-1-1 uk-width-1-3@m uk-text-zero">
        <h3><?php echo JText::_('CONTACT_INFO'); ?></h3>
        <div class="uk-margin-medium-bottom">
            <ul class="uk-grid-small" data-uk-grid>
                <li class="uk-text-small uk-flex uk-flex-middle uk-width-1-1"><i class="fas fa-map-signs fa-fw fa-lg uk-margin-left uk-text-secondary"></i><span class="uk-text-white font f500"><?php echo $params->get('address'); ?></span></li>
                <li class="uk-text-small uk-flex uk-flex-middle uk-width-1-2 uk-width-1-1@m"><i class="fas fa-phone fa-flip-horizontal fa-fw fa-lg uk-margin-left uk-text-secondary"></i><a href="tel:<?php echo $params->get('phone'); ?>" class="uk-text-white font f500 ltr"><?php echo $params->get('phone'); ?></a></li>
                <li class="uk-text-small uk-flex uk-flex-middle uk-width-1-2 uk-width-1-1@m"><i class="fas fa-fax fa-fw fa-lg uk-margin-left uk-text-secondary"></i><span class="uk-text-white font f500 ltr"><?php echo $params->get('fax'); ?></span></li>
                <li class="uk-text-small uk-flex uk-flex-middle uk-width-1-2 uk-width-1-1@m"><i class="fas fa-envelope-open-text fa-fw fa-lg uk-margin-left uk-text-secondary"></i><a href="mailto:<?php echo $params->get('email'); ?>" class="uk-text-white font f500 ltr"><?php echo $params->get('email'); ?></a></li>
            </ul>
        </div>
                            ...
                            <?php foreach ($params->get('socials') as $item) : ?>
                                <?php if ($item->icon != '') { ?>
                                    <?php if ($item->icon != 'aparat') { ?>
                                        <li><a href="<?php echo $item->link; ?>" title="<?php echo $item->title; ?>" data-uk-tooltip class="uk-flex uk-flex-center uk-flex-middle" target="_blank" id="<?php echo $item->title; ?>"><i class="fab fa-<?php echo $item->icon; ?>"></i></a></li>
                                    <?php } else { ?>
                                        <li><a href="<?php echo $item->link; ?>" title="<?php echo $item->title; ?>" class="uk-flex uk-flex-center uk-flex-middle" target="_blank" id="<?php echo $item->title; ?>"><img src="<?php echo JUri::base().'images/sprite.svg#'.$item->icon; ?>" width="18" height="18" data-uk-svg></a></li>
                                    <?php } ?>
                                <?php } ?>
                            <?php endforeach; ?>
                        </ul>
...
<!--                        </div>-->
        ...
        <div class="uk-text-center uk-text-right@m copyright">
            <div class="uk-container">
                ...
                <div class="uk-width-expand">
                    <div class="offcanvasTop uk-box-shadow-small uk-position-relative uk-flex-stretch">
                        <div class="uk-grid-collapse uk-height-1-1" data-uk-grid>
                            ...
                            <div class="uk-flex uk-width-expand uk-flex uk-flex-right uk-flex-middle uk-text-white logo"><img src="<?php echo JUri::base().'images/sprite.svg#logo' ?>" width="" height="30" alt="<?php echo $sitename; ?>" data-uk-svg></div>
                        </div>
                    </div>
